...
const Button = ({ children, variant = 'primary', className = '', ...props }) => {
  ...
  const variants = {
    ...
    user: "bg-gradient-to-tr from-teal-600 via-teal-500 to-emerald-400 text-white shadow-[0_4px_14px_0_rgba(20,184,166,0.39)] hover:shadow-[0_6px_20px_rgba(20,184,166,0.23)] hover:-translate-y-0.5 focus:ring-teal-500",
