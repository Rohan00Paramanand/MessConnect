    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 pb-4">
        <div className="flex items-center gap-3 mb-5">
          <img src="/pcet.webp" alt="MessConnect Logo" className="w-10 h-10 flex-shrink-0 object-cover rounded-xl shadow-md ring-1 ring-gray-200" />
          <h1 className="text-xl font-black text-gray-900 tracking-tight">PCET MessConnect</h1>
        </div>
        {role && (
