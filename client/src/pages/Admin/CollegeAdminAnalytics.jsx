...
export default function CollegeAdminAnalytics() {
  ...
  const fetchAnalytics = useCallback(async (isManualRefresh = false) => {
    ...
    try {
      ...
      if (res.data?.status === 'success') {
        ...
        if (isManualRefresh) toast.success('Campus analytics updated');
      }
    } catch (err) {
  ...
  const TABS = [
    { id: 'overview', label: 'Campus Overview', icon: LayoutDashboard, badge: null },
    { id: 'messes', label: 'Mess Facilities', icon: UtensilsCrossed, badge: kpis?.activeMesses || null },
    { id: 'grievances', label: 'Grievances & CSAT', icon: MessageSquare, badge: kpis?.pendingComplaints || null },
    { id: 'staff', label: 'Staff Workforce', icon: Users, badge: kpis?.totalStaff || null },
  ];
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="flex items-center justify-between gap-2 md:gap-3 bg-white/95 backdrop-blur-md rounded-2xl p-1.5 border border-gray-200/80 shadow-sm sticky top-2 z-30">
        ...
        {/* Top Right Actions: Refresh Data & Quick Approvals */}
        <div className="flex items-center gap-2 flex-shrink-0 pr-1">
          <NavLink
            to="/approvals"
            className="hidden md:inline-flex items-center gap-1.5 px-3 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold rounded-xl border border-indigo-200 transition-colors"
          >
          ...
          <button
            ...
            title="Refresh Campus Analytics"
          >
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4">
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between text-gray-400 mb-2">
                <span className="text-[11px] md:text-xs font-bold uppercase tracking-wider text-gray-500">Students</span>
                <div className="p-2 bg-emerald-50 text-emerald-600 rounded-xl">
                  <Users className="w-4 h-4 md:w-5 md:h-5" />
                </div>
              </div>
              <div className="text-xl md:text-2xl font-black text-gray-900">{kpis?.totalStudents || 0}</div>
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between text-gray-400 mb-2">
                <span className="text-[11px] md:text-xs font-bold uppercase tracking-wider text-gray-500">Vendors</span>
                <div className="p-2 bg-blue-50 text-blue-600 rounded-xl">
                  <Award className="w-4 h-4 md:w-5 md:h-5" />
                </div>
              </div>
              <div className="text-xl md:text-2xl font-black text-gray-900">{kpis?.totalVendors || 0}</div>
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between text-gray-400 mb-2">
                <span className="text-[11px] md:text-xs font-bold uppercase tracking-wider text-gray-500">Committee</span>
                <div className="p-2 bg-cyan-50 text-cyan-600 rounded-xl">
                  <UserCheck className="w-4 h-4 md:w-5 md:h-5" />
                </div>
              </div>
              <div className="text-xl md:text-2xl font-black text-gray-900">{kpis?.totalCommittee || 0}</div>
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between text-gray-400 mb-2">
                <span className="text-[11px] md:text-xs font-bold uppercase tracking-wider text-gray-500">Dining Halls</span>
                <div className="p-2 bg-indigo-50 text-indigo-600 rounded-xl">
                  <UtensilsCrossed className="w-4 h-4 md:w-5 md:h-5" />
                </div>
              </div>
              <div className="text-xl md:text-2xl font-black text-gray-900">{kpis?.totalMesses || 0}</div>
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xl md:text-2xl font-black text-gray-900">{kpis?.totalComplaints || 0}</div>
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between text-gray-400 mb-2">
                <span className="text-[11px] md:text-xs font-bold uppercase tracking-wider text-gray-500">Avg Campus Rating</span>
                <div className="p-2 bg-amber-50 text-amber-500 rounded-xl">
                  <Star className="w-4 h-4 md:w-5 md:h-5 fill-amber-400" />
                </div>
              </div>
              <div className="flex items-baseline gap-1">
                <span className="text-xl md:text-2xl font-black text-gray-900">{kpis?.avgRating ? kpis.avgRating.toFixed(1) : '—'}</span>
          ...
          {/* Quick Overview Snapshot: Grievances & Top Messes */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* Campus Grievance Telemetry Preview */}
            <div className="lg:col-span-7 bg-white p-5 md:p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  View Grievances <ArrowUpRight className="w-3.5 h-3.5" />
                </button>
              </div>
            ...
            {/* Mess Ratings & Facility Highlights */}
            <div className="lg:col-span-5 bg-white p-5 md:p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-base font-black text-gray-900 tracking-tight">Facility Satisfaction</h3>
                  <button
                    onClick={() => setActiveTab('messes')}
                    className="text-xs font-bold text-indigo-600 hover:text-indigo-700 inline-flex items-center gap-1"
                  >
                    View All Messes <ArrowUpRight className="w-3.5 h-3.5" />
                  </button>
                </div>

                <div className="space-y-3">
                  {messPerformance && messPerformance.length > 0 ? (
                    messPerformance.slice(0, 3).map((mess) => (
                      <div key={mess.id} className="p-3 bg-gray-50/80 rounded-xl border border-gray-100 flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <div className="font-bold text-gray-900 text-xs">{mess.name}</div>
                            <div className="text-[10px] text-gray-400">
                              {mess.vendor?.companyName || 'No Vendor'}
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-1 bg-amber-50 px-2 py-0.5 rounded-lg border border-amber-200 text-xs font-bold text-gray-900">
                          <Star className="w-3 h-3 text-amber-500 fill-amber-400" />
                          <span>{mess.avgRating > 0 ? mess.avgRating.toFixed(1) : '—'}</span>
                        </div>
                      </div>
                    ))
                  ) : (
                    <p className="text-xs text-gray-400 py-6 text-center">No mess facilities registered yet.</p>
                  )}
                </div>
              </div>

              <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
                <span>Active Dining Facilities: <strong>{kpis?.activeMesses || 0}</strong> of {kpis?.totalMesses || 0}</span>
                <span className="text-emerald-600 font-semibold">Active Operational Matrix</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
          TAB 2: MESS FACILITIES OPERATIONAL BENCHMARKS
      ────────────────────────────────────────────────────────────── */}
      {activeTab === 'messes' && (
        <div className="space-y-6 animate-fadeIn">
          {/* Quick Metrics Strip */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-gray-500 font-semibold">Registered Facilities</span>
              <div className="text-2xl font-black text-gray-900 mt-1">{kpis?.totalMesses || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-emerald-600 font-semibold">Currently Active</span>
              <div className="text-2xl font-black text-emerald-600 mt-1">{kpis?.activeMesses || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-amber-600 font-semibold">Average Facility Rating</span>
              <div className="text-2xl font-black text-amber-600 mt-1 flex items-center gap-1">
                <Star className="w-5 h-5 fill-amber-400 text-amber-500" />
                <span>{kpis?.avgRating ? kpis.avgRating.toFixed(1) : '—'}</span>
              </div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-rose-600 font-semibold">Facility Grievances</span>
              <div className="text-2xl font-black text-rose-600 mt-1">{kpis?.pendingComplaints || 0}</div>
              <span className="text-[11px] text-gray-400 font-medium">pending resolution</span>
            </div>
          </div>

          {/* Mess Facility Operational Performance Table */}
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-5 md:p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-black text-gray-900 tracking-tight">Mess Facilities Operational Performance</h3>
                <p className="text-xs text-gray-500 mt-0.5">
                  Detailed inspection of individual dining hall health, vendor accountability, student satisfaction, and complaints.
                </p>
              </div>

              <NavLink
                to="/messes"
                className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold rounded-xl border border-indigo-200 transition-colors w-fit"
              >
                <UtensilsCrossed className="w-3.5 h-3.5" />
                <span>Configure Mess Facilities</span>
              </NavLink>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm min-w-[700px]">
                <thead className="bg-gray-50/70 border-b border-gray-100 text-[11px] uppercase tracking-wider text-gray-500 font-bold">
                  <tr>
                    <th className="px-6 py-3.5">Mess Hall Name</th>
                    <th className="px-6 py-3.5">Assigned Vendor</th>
                    <th className="px-6 py-3.5 text-center">Avg Rating</th>
                    <th className="px-6 py-3.5 text-center">Reviews</th>
                    <th className="px-6 py-3.5 text-center">Pending Grievances</th>
                    <th className="px-6 py-3.5 text-center">Resolved</th>
      ...
      {activeTab === 'grievances' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-gray-500 font-semibold">Total Grievances</span>
              <div className="text-2xl font-black text-gray-900 mt-1">{kpis?.totalComplaints || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-rose-600 font-semibold">Awaiting Resolution</span>
              <div className="text-2xl font-black text-rose-600 mt-1">{kpis?.pendingComplaints || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-emerald-600 font-semibold">Resolved Successfully</span>
              <div className="text-2xl font-black text-emerald-600 mt-1">{complaints?.byStatus?.resolved || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-amber-600 font-semibold">Average Student CSAT</span>
              <div className="text-2xl font-black text-amber-600 mt-1 flex items-center gap-1">
                <Star className="w-5 h-5 fill-amber-400 text-amber-500" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* Complaints Telemetry Bar Chart */}
            ...
            {/* Student Satisfaction Quality Index */}
            <div className="lg:col-span-6 bg-white p-5 md:p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div>
      ...
      {activeTab === 'staff' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-gray-500 font-semibold">Total Verified Staff</span>
              <div className="text-2xl font-black text-gray-900 mt-1">{kpis?.totalStaff || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-indigo-600 font-semibold">Culinary Cooks</span>
              <div className="text-2xl font-black text-indigo-600 mt-1">{staff?.byRole?.Cook || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-teal-600 font-semibold">Hygiene & Cleaners</span>
              <div className="text-2xl font-black text-teal-600 mt-1">{staff?.byRole?.Cleaner || 0}</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
              <span className="text-xs text-blue-600 font-semibold">Managers & Cashiers</span>
              <div className="text-2xl font-black text-blue-600 mt-1">
                {(staff?.byRole?.Manager || 0) + (staff?.byRole?.Cashier || 0)}
              </div>
            </div>
          </div>

          {/* Campus Workforce & Staffing Status Card */}
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <h3 className="text-lg font-black text-gray-900 tracking-tight">Campus Workforce & Staffing Status</h3>
                <p className="text-xs text-gray-500">Deployment breakdown of cooks, cleaners, cashiers, and mess managers</p>
              </div>
              <NavLink to="/staff" className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold rounded-xl border border-indigo-200 transition-colors w-fit">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
              {['Cook', 'Cleaner', 'Cashier', 'Manager'].map((role) => (
                <div key={role} className="bg-gray-50/80 border border-gray-100 p-5 rounded-xl hover:bg-white hover:shadow-sm transition-all">
