...
const NoticeBoard = () => {
  ...
  const targetRoleColor = { all: 'bg-gray-100 text-gray-700', user: 'bg-teal-100 text-teal-700', vendor: 'bg-rose-100 text-rose-700', mess_committee: 'bg-amber-100 text-amber-700' };
